...
- The generated HTML opens the radial menu first, then triggers webview resize in the background from `BTTInitialize()`.
- It prefers `callBTT('resize_webview', { width: 500, height: 500 })`, with fallback to `resize_webview(...)`.
